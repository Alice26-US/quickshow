...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-start justify-center gap-4 px-6 md:px-16 lg:px-36 bg-[url('assets/backgroundimage.png')] bg-cover bg-center h-screen">
        ...
        <h1 className="text-5ml md:text-[70px] md:leading-18 font-semibold max-w-110">Guardians<br/>of the Galaxy</h1>
        ...
        <p className="max-w-md text-gray-300">In a post-apocalyptic world 
         where cities ride on wheels and consume each other to survive, two people meet in 
         ...
         <button onClick={()=> navigate('/movies')} className="flex items-center gap-1 px-6 py-3 text-sm bg-primary
          hover:*:bg-primary-dull transitionrounded-full font-medium cursor-pointer">
            Explore Movies
