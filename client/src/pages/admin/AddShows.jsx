    ...
    <>
     ...
     <div className="overflow-x-auto pb-4">
      <div className="group flex flex-wrap gap-4 mt-4 w-max" >
        ...
        <div key={movie.id } className={`relative max-w-48 cursor-pointer 
          ...
          duration-300`} onClick={()=> setSelectedMovie(movie.id)}>
            ...
            {selectedMovie === movie._id && (
              ...
              justify-center h-4 w-4 rounded">
     ...
     <div className="mt-8">
      ...
      <div className="inline-flex items-center gap-5 border border-gray-600 
       p-1 pl-3 rounded-lg">
              ...
              <div className="flex flex-wrap gap-2 mt-1 text-sm">
                {times.map((time) => (
                  <div key={time} className="border border-primary px-2 py-1 flex items-center rounded">
                    ...
                    className="ml-2 hover:text-red-700 cursor-pointer" />
                  </div>
                ))}
              </div>
            </li>
