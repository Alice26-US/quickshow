...
const Dashboard = () => {
  ...
  const dashboardCards = [
    ...
    { title: "Total Active Shows", value: dashboardData.totalBookings || "0", icon:PlayCircleIcon},
    { title: "TotalUsers", value: dashboardData.totalBookings || "0", icon:UsersIcon },
  ]
  ...
  <>
    ...
    <div className="relative flex flex-wrap gap-6 mt-4 max-w-5xl">
      ...
      {dashboardData.activeShows.map((show) => (
          ...
          h-full pb-3 bg-primary/10 border 
